...
struct YuzuPlayerScreen: View {
    ...
    private func prepare(_ item: VideoItem) {
        ...
        // 使用播放型 Audio Session，讓影片即使裝置處於靜音模式也能正常出聲。
        // 音量手勢只調整這個 AVPlayer，不會修改 iOS 系統音量。
    ...
    private func configureAudioSession() {
        ...
        do {
            ...
            print("YuzuPlayer Audio Session 設定失敗: \(error.localizedDescription)")
        }
    }
    ...
    private func cleanup() {
        ...
        do {
            ...
            print("YuzuPlayer Audio Session 關閉失敗: \(error.localizedDescription)")
        }
    }
