...
final class PlayerSettings: ObservableObject {
    ...
    @Published var leftDoubleTapEnabled: Bool { didSet { save("player.gestures.leftDouble", leftDoubleTapEnabled) } }
    @Published var rightDoubleTapEnabled: Bool { didSet { save("player.gestures.rightDouble", rightDoubleTapEnabled) } }
    ...
    private init() {
        ...
        leftDoubleTapEnabled = defaults.object(forKey: "player.gestures.leftDouble") as? Bool ?? true
        rightDoubleTapEnabled = defaults.object(forKey: "player.gestures.rightDouble") as? Bool ?? true
    ...
    func setAllGestures(_ enabled: Bool) {
        ...
        leftDoubleTapEnabled = enabled
        rightDoubleTapEnabled = enabled
        ...
        Form {
            ...
            Section("播放器手勢") {
                ...
                Group {
                    ...
                    Toggle("雙擊左側快退 10 秒", isOn: $settings.leftDoubleTapEnabled)
                    Toggle("雙擊右側快進 10 秒", isOn: $settings.rightDoubleTapEnabled)
