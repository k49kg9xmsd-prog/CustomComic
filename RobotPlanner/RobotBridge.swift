...
private final class RobotStore {
    ...
    func listSaves()->[String] { contents(folder(.saves)).filter{$0.pathExtension.lowercased()=="json"}.map(\.lastPathComponent).sorted{$0.localizedCaseInsensitiveCompare($1)==.orderedAscending} }
